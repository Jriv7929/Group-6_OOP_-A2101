...
public class FullDetailsPanel extends JPanel {
    ...
    public FullDetailsPanel() {
        ...
        setPasswordBtn.addActionListener(e -> createLoginCredential());
    ...
    private void createLoginCredential(){

    String empId = empNo.getText().trim();
    String first = firstName.getText().trim();
    String last = lastName.getText().trim();

    if(empId.isEmpty() || first.isEmpty() || last.isEmpty()){
        JOptionPane.showMessageDialog(
                this,
    ...
    // Username format: First letter of FirstName + LastName
    String username =
    ...
    loginService.createCredential(empId, username, role, password);

    JOptionPane.showMessageDialog(
            this,
            "Login credential created.\nUsername: " + username +
