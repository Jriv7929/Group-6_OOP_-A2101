...
public class CSVHandler {
    ...
    public static void appendToCSV(String filePath, String... data) {
        try (BufferedWriter writer =
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Failed to write to CSV: " + e.getMessage()
            );
        }
    }

    public static void updateCSV(String filePath,
                                 String empNo,
                                 String... data) {
        ...
        try (BufferedReader reader =
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Error updating CSV: " + e.getMessage()
            );
            return;
        }
    ...
    public static void deleteFromCSV(String filePath, String empNo) {
        ...
        if (!inputFile.delete() || !tempFile.renameTo(inputFile)) {
            JOptionPane.showMessageDialog(
                    null,
                    "Could not update CSV file after deletion."
            );
        }
    }

    public static Set<String> loadAvailableMonths(String filePath,
                                                  String empNo,
        ...
        try (Scanner scanner =
                     new Scanner(new File(filePath), "UTF-8")) {
    ...
    public static void loadEmployeeData(String filePath,
                                        DefaultTableModel model) {

        try (Scanner scanner =
                     new Scanner(new File(filePath), "ISO-8859-1")) {
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Failed to load Employee CSV: " + e.getMessage()
            );
        }
    }
}
