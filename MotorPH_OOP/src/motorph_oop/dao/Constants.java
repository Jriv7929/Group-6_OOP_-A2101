...
public class Constants {
    public static final String EMPLOYEE_DATA_CSV = "src\\motorph_oop\\resources\\MotorPH_EmployeeData.csv";
    public static final String ATTENDANCE_CSV = "src\\motorph_oop\\resources\\MotorPH_AttendanceRecord.csv";
    public static final String LOGIN_CSV = "src\\motorph_oop\\resources\\MotorPH_EmployeeLogin.csv";
