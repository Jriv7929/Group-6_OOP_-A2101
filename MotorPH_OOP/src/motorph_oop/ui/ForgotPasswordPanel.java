...
public class ForgotPasswordPanel extends JFrame {
    ...
    // Constructor: builds Forgot Password UI.
    public ForgotPasswordPanel() {
        ...
        welcomeLabel.setBorder(
                BorderFactory.createEmptyBorder(60, 0, -5, 0)
        );

        JLabel imageLabel =
                new JLabel(
                        new ImageIcon("src/images/motorphimage.png")
                );
        ...
        JLabel loginLabel =
                new JLabel("Please enter your credentials");
