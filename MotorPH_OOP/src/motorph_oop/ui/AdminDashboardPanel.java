...
import motorph_oop.ui.LeaveApprovalPanel;
...
public class AdminDashboardPanel extends JFrame {
    ...
    AdminDashboardPanel(String employeenum,
                        String accesslevel,
                        String loginnum,
                        String lastname,
                        String firstname) {
        ...
        // NEW BUTTON
        JButton btnManageLogin =
                UIUtils.createNavButton("Manage Login", Color.white, Color.black);
        ...
        if (userRole.equalsIgnoreCase("Admin")) {
            ...
            // Move logout near bottom but keep spacing
            ...
            // Placeholder action for Manage Login
            btnManageLogin.addActionListener(e ->
                    JOptionPane.showMessageDialog(this,
                            "Manage Login panel not yet implemented.")
            );
        }
