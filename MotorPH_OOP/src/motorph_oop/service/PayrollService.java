...
public class PayrollService {
    ...
    public static PayrollResult calculatePayroll(Employee employee, String attendanceFile, String selectedMonth) {
    ...
    private static double calculateGrossSalary(Employee employee, double hoursWorked) {
